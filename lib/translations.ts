  ...
  en: {
    ...
    testimonials: {
      ...
      quotes: [
        ...
        {
          text: "As a veteran, I trust someone who served. Nicholas gets it.",
          name: "James T.",
          neighborhood: "Logan Square",
        },
        {
          text: "My family speaks Spanish at home. The fact that this site works in Spanish tells me Nicholas actually cares about us.",
          name: "Maria L.",
  ...
  es: {
    ...
    testimonials: {
      ...
      quotes: [
        ...
        {
          text: "Como veterano, confío en alguien que sirvió. Nicholas lo entiende.",
          name: "James T.",
          neighborhood: "Logan Square",
        },
        {
          text: "Mi familia habla español en casa. El hecho de que este sitio funcione en español me dice que Nicholas realmente se preocupa por nosotros.",
          name: "Maria L.",
          neighborhood: "Avondale",
        },
      ],
